...
void game_init() {
  ...
  enemy_uno_id = spawn_entity(E_ENEMY, (Vector2){400.0f, 150.0f});
  enemy_dos_id = spawn_entity(E_ENEMY, (Vector2){500.0f, 150.0f});
  enemy_tres_id = spawn_entity(E_ENEMY, (Vector2){400.0f, 250.0f});
}
